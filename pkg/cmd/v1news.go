...
var v1NewsGetNews = cli.Command{
	...
	Action:          handleV1NewsGetNews,
	HideHelpCommand: true,
}

func handleV1NewsGetNews(ctx context.Context, cmd *cli.Command) error {
	...
	params := clearstreet.V1NewsGetNewsParams{}

	var res []byte
	options = append(options, option.WithResponseBodyInto(&res))
	_, err = client.V1.News.GetNews(ctx, params, options...)
	if err != nil {
		return err
	}
