...
func handleActiveV1InstrumentsGetInstrumentByID(ctx context.Context, cmd *cli.Command) error {
	...
	return ShowJSON(os.Stdout, os.Stderr, "active:v1:instruments get-instrument-by-id", obj, format, explicitFormat, transform)
}
...
func handleActiveV1InstrumentsGetInstruments(ctx context.Context, cmd *cli.Command) error {
	...
	explicitFormat := cmd.Root().IsSet("format")
	transform := cmd.Root().String("transform")
	return ShowJSON(os.Stdout, os.Stderr, "active:v1:instruments get-instruments", obj, format, explicitFormat, transform)
}
