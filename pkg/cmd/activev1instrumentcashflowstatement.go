...
var activeV1InstrumentsCashFlowStatementsGetInstrumentCashFlowStatements = cli.Command{
	...
	Action:          handleActiveV1InstrumentsCashFlowStatementsGetInstrumentCashFlowStatements,
	HideHelpCommand: true,
}

func handleActiveV1InstrumentsCashFlowStatementsGetInstrumentCashFlowStatements(ctx context.Context, cmd *cli.Command) error {
	...
	params := clearstreet.ActiveV1InstrumentCashFlowStatementGetInstrumentCashFlowStatementsParams{
	...
	return ShowJSON(obj, ShowJSONOpts{
		...
		Title:          "active:v1:instruments:cash-flow-statements get-instrument-cash-flow-statements",
		Transform:      transform,
	})
}
