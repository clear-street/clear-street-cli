...
var v1InstrumentsCashFlowStatementsGetInstrumentCashFlowStatements = cli.Command{
	...
	Action:          handleV1InstrumentsCashFlowStatementsGetInstrumentCashFlowStatements,
	HideHelpCommand: true,
}

func handleV1InstrumentsCashFlowStatementsGetInstrumentCashFlowStatements(ctx context.Context, cmd *cli.Command) error {
	...
	params := clearstreet.V1InstrumentCashFlowStatementGetInstrumentCashFlowStatementsParams{}
	...
	return ShowJSON(obj, ShowJSONOpts{
		...
		Title:          "v1:instruments:cash-flow-statements get-instrument-cash-flow-statements",
		Transform:      transform,
	})
}
