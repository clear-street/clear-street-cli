...
var activeV1InstrumentsIncomeStatementsGetInstrumentIncomeStatements = cli.Command{
	...
	Action:          handleActiveV1InstrumentsIncomeStatementsGetInstrumentIncomeStatements,
	HideHelpCommand: true,
}

func handleActiveV1InstrumentsIncomeStatementsGetInstrumentIncomeStatements(ctx context.Context, cmd *cli.Command) error {
	...
	return ShowJSON(obj, ShowJSONOpts{
		...
		Title:          "active:v1:instruments:income-statements get-instrument-income-statements",
		Transform:      transform,
	})
}
