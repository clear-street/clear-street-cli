...
import (
	...
	"github.com/clear-street/clear-street-cli/pkg/cmd"
...
func main() {
	...
	if baseURL, ok := os.LookupEnv("CLEAR_STREET_BASE_URL"); ok {
		if err := cmd.ValidateBaseURL(baseURL, "CLEAR_STREET_BASE_URL"); err != nil {
